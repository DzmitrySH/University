...
namespace University.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder,  int? pageNumber)
        {
            ...
            var enrollments = from s in _context.Enrollments.Include(e => e.Course).Include(e => e.Student)
                              select s;

            switch (sortOrder)
            {
                case "name_desc":
                    enrollments = enrollments.OrderByDescending(s => s.Student.FirstMidName);
                    break;
                default:
                    enrollments = enrollments.OrderBy(s => s.Student.FirstMidName);
                    break;
            }
            int pageSize = 4;
        ...
        {
            ViewData["CourseID"] = new SelectList(_context.Courses, "CourseID", /*"CourseID",*/ "Title");
            ViewData["StudentID"] = new SelectList(_context.Students, "ID", /*"ID",*/"FirstMidName");
            return View();
        }
